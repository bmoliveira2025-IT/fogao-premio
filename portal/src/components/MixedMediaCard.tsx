...
export default function MixedMediaCard({ item, index = 0, className = '' }: MixedMediaCardProps) {
        ...
        return (
            ...
            >
                ...
                <div className="p-4 md:p-5">
                    <h3 className="text-[16px] md:text-[18px] font-bold text-zinc-900 dark:text-white line-clamp-2 group-hover:text-premium-gold transition-colors normal-case">
        ...
        return (
            ...
            >
                ...
                <div className="relative p-4 md:p-5">
                    ...
                    {/* Title */}
                    <h3 className="text-[25.5px] md:text-[28px] font-black mb-3 group-hover:text-premium-gold transition-colors normal-case" style={{ color: 'var(--foreground)' }}>
                        {toSentenceCase(item.title)}
                    </h3>
    ...
    return (
        ...
        >
            ...
            {/* News Info */}
            <div className="p-4 md:p-5">
                <h3 className="text-[18px] md:text-[22px] font-bold line-clamp-2 mb-3 group-hover:text-premium-gold transition-colors normal-case" style={{ color: 'var(--foreground)' }}>
                    {toSentenceCase(item.title)}
                </h3>
