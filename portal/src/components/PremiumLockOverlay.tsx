    ...
    return (
        <div className="relative mt-2">
            ...
            <div className="relative z-20 bg-[#0a0a0a] pb-10 pt-4 flex flex-col items-center text-center px-6">
                {/* Premium Card */}
                <div className="w-full max-w-sm bg-[#121212] border border-premium-gold/30 rounded-2xl p-8 relative overflow-hidden shadow-[0_0_50px_rgba(212,175,55,0.1)]">
                    {/* Glow */}
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <div className="space-y-3 w-full">
                            <button className="w-full py-4 bg-gradient-to-r from-[#D4AF37] to-[#B8860B] rounded-xl text-black font-black uppercase tracking-[0.2em] text-xs hover:brightness-110 active:scale-[0.98] transition-all shadow-lg flex items-center justify-center space-x-2">
